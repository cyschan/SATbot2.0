...
training_config['model_save_path'] = 'gad_7_baseline'
training_config['stats_file_name'] = 'gad_7_baseline'
...
for run in range(5):
    training_config['model_save_path'] = 'gad_7_baseline_cloud_vm_fine_tune_run_{}'.format(run)
    training_config['stats_file_name'] = 'gad_7_baseline_cloud_vm_fine_tune_run_{}'.format(run)

    # Create models
    best_hs_path = '/vol/bitbucket/jat415/emotiondetection/emotion_recognition/Framework/models/phq_prediction/trained/baseline_hs.pth'
    best_agg_path = '/vol/bitbucket/jat415/emotiondetection/emotion_recognition/Framework/models/phq_prediction/trained/baseline_agg.pth'

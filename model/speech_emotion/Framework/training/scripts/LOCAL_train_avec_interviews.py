...
training_config['model_dir'] = '/FYP/final-year-project/data/'
...
training_config['valid_every_n_steps'] = 40
...
training_config['model_save_path'] = 'avec_model_hidden_agg_with_emotion'
training_config['stats_file_name'] = 'avec_model_hidden_agg_with_emotion'
training_config['alpha'] = 3

# Create config for the dataset
dataset_config = dict()
dataset_config['root_dir'] = '/FYP/final-year-project/data/AVEC/AVEC_Challenge_Packed'
...
# Create models
best_model_path = '/dockerx/emotiondetection/emotion_recognition/Framework/emotion_recognition_tool/best_model.pth'
...
agg_model = AggregatorModel(phq_hidden_size=1024, phq_shrink_hidden_size=17*4, emotion_logit_length=17)

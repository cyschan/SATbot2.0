...
training_config['model_dir'] = '/vol/bitbucket/jat415/checkpoints/final'
...
training_config['model_save_path'] = 'finished_emotion_model'
training_config['stats_file_name'] = 'finished_emotion_model'
training_config['alpha'] = 3

# Create config for the dataset
dataset_config = dict()
dataset_config['root_dir'] = '/FYP/final-year-project/data/IEMOCAP_full_release'

...
from model.speech_emotion.Framework.training.training_loops.avec_interview_training_loop_hidden import TrainOnAVEC
...
training_config['valid_every_n_steps'] = 2
...
training_config['model_save_path'] = 'depression_prediction_with_hidden_states'
training_config['stats_file_name'] = 'depression_prediction_with_hidden_states'
...
for run in range(2):
    print('training hidden state model #', run)
    training_config['model_save_path'] = 'slow_depression_prediction_with_hidden_states_run_{}'.format(run)
    training_config['stats_file_name'] = 'slow_depression_prediction_with_hidden_states_run_{}'.format(run)
...
for run in range(2):
    print('training baseline model #', run)
    training_config['model_save_path'] = 'slow_depression_prediction_baseline_run_{}'.format(run)
    training_config['stats_file_name'] = 'slow_depression_prediction_baseline_run_{}'.format(run)
    # Create models
    emotion_model = None

...
for run in range(1, 2):
    ...
    training_config['model_save_path'] = 'slow_depression_prediction_with_emotion_only_run_{}'.format(run)
    training_config['stats_file_name'] = 'slow_depression_prediction_with_emotion_only_run_{}'.format(run)

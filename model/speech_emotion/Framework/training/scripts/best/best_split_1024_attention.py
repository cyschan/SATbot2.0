...
from model.speech_emotion.Framework.global_config import set_gpu
from model.speech_emotion.Framework.models.emotion_recognition.emotion_recognition_model_split_attention_full_att import EmotionRecognitionModel
...
# Validate 8 times per epoch
training_config['valid_every_n_steps'] = 271
...
training_config['model_save_path'] = 'emotion_model_split_1024_attention_slow'
training_config['stats_file_name'] = 'emotion_model_split_1024_attention_slow'

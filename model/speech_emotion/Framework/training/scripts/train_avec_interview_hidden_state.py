...
for run in range(1, 5):
    ...
    training_config['model_save_path'] = 'depression_prediction_with_hidden_states_run_{}'.format(run)
    training_config['stats_file_name'] = 'depression_prediction_with_hidden_states_run_{}'.format(run)
